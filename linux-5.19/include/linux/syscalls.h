 ...
 */
#ifndef CONFIG_ARCH_HAS_SYSCALL_WRAPPERS
asmlinkage long sys_hello(void);
asmlinkage long sys_fork_if_not_disable(void);
asmlinkage long sys_disable_fork(void);
asmlinkage long sys_close_all_files(void);
